...
RUN if [ "$TARGETARCH" = "arm64" ]; then \
    apk add --no-cache --repository http://dl-cdn.alpinelinux.org/alpine/edge/community --virtual .build-deps-nr php7-dev git go musl-dev pcre2-dev pcre-dev build-base automake libtool unzip; \
